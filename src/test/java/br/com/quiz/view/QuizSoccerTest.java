...
public class QuizSoccerTest {
	...
	public static void initialSetup(){
		...
		quizesJohnPlayer.put(QuizType.SOCCER, new QuizResult(Level.BASIC,1,1));
		quizesJohnPlayer.put(QuizType.MOVIE, new QuizResult());
		...
		quizesRobertPlayer.put(QuizType.SOCCER, new QuizResult(Level.INTERMEDIATE,1,1));
		quizesRobertPlayer.put(QuizType.MOVIE, new QuizResult());
		...
		quizesPaulPlayer.put(QuizType.SOCCER, new QuizResult(Level.ADVANCED,1,1));
		quizesPaulPlayer.put(QuizType.MOVIE, new QuizResult());
	...
	public void testBasicLevelWin() throws IOException{
		StringBuilder builder = new StringBuilder(TestConstants.PETER_PLAYER)
								...
								.append(Constants.NUMBER_TO_QUIZ_SOCCER).append(Constants.LINE_SEPARATOR).append(2)
		...
		Assert.assertEquals(1, quizSoccerResult.getCorrectAnswers());
		Assert.assertEquals(1, quizSoccerResult.getQuestionsNumber());
		...
		Assert.assertEquals(0, quizMovieResult.getQuestionsNumber());
	}
	...
	public void testBasicLevelLose() throws IOException{
		StringBuilder builder = new StringBuilder(TestConstants.PETER_PLAYER)
								.append(Constants.LINE_SEPARATOR).append(Constants.NUMBER_TO_PLAY).append(Constants.LINE_SEPARATOR)
								.append(Constants.NUMBER_TO_QUIZ_SOCCER).append(Constants.LINE_SEPARATOR).append(3)
								.append(Constants.LINE_SEPARATOR).append(Constants.NUMBER_TO_COME_BACK)
								.append(Constants.LINE_SEPARATOR).append(Constants.NUMBER_TO_RESUME)
								.append(Constants.LINE_SEPARATOR).append(Constants.NUMBER_TO_SAVE)
								.append(Constants.LINE_SEPARATOR).append(Constants.NUMBER_TO_EXIT);
	...
	public void testIntermediateLevelWin() throws IOException{
		StringBuilder builder = new StringBuilder(TestConstants.JOHN_PLAYER)
								.append(Constants.LINE_SEPARATOR).append(Constants.NUMBER_TO_PLAY).append(Constants.LINE_SEPARATOR)
								.append(Constants.NUMBER_TO_QUIZ_SOCCER).append(Constants.LINE_SEPARATOR).append(1)
								.append(Constants.LINE_SEPARATOR).append(Constants.NUMBER_TO_COME_BACK)
								.append(Constants.LINE_SEPARATOR).append(Constants.NUMBER_TO_RESUME)
								.append(Constants.LINE_SEPARATOR).append(Constants.NUMBER_TO_SAVE)
								.append(Constants.LINE_SEPARATOR).append(Constants.NUMBER_TO_EXIT);
		...
		QuizResult quizSoccerResult = scorePlayer.getQuizes().get(QuizType.SOCCER);
		Assert.assertEquals(Level.INTERMEDIATE, quizSoccerResult.getLevel());
		Assert.assertEquals(1, quizSoccerResult.getCorrectAnswers());
		Assert.assertEquals(1, quizSoccerResult.getQuestionsNumber());
	...
	public void testAdvancedLevelWin() throws IOException{
		...
		QuizResult quizSoccerResult = scorePlayer.getQuizes().get(QuizType.SOCCER);
		Assert.assertEquals(Level.ADVANCED, quizSoccerResult.getLevel());
		Assert.assertEquals(1, quizSoccerResult.getCorrectAnswers());
		Assert.assertEquals(1, quizSoccerResult.getQuestionsNumber());
